...
inline code_intel::CodeIntelOptions code_intel_options_from_args(const Json& args) {
...
inline code_intel::CodeIntelQuery code_intel_query_from_args(const Json& args) {
...
inline void register_code_intel_tools(llm::ToolRegistry& registry,
