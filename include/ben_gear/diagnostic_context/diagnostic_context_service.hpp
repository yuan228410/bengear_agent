...
public:
    ...
    domain::AppResult<RepairContextResult> repair_context(RepairContextRequest request) const;
    domain::AppResult<RepairContextResult> repair_context(RepairContextRequest request,
