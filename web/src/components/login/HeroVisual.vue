...
.hero-visual--midnight .hero-core { border-radius: var(--radius-md); }
.hero-visual--coral { border-radius: var(--radius-md); }
...
.hero-visual--nord { border-radius: var(--radius-md); }
.hero-visual--graphite .hero-core { border-radius: var(--radius-md); }
