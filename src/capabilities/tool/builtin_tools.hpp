...
void register_file_tools(capabilities::tool::ToolRegistry& registry);
...
void register_replace_tools(capabilities::tool::ToolRegistry& registry);

/// 注册子串搜索工具：search_content（无正则开销）
void register_search_content_tools(capabilities::tool::ToolRegistry& registry);

/// 注册环境变量工具：env_get, env_set
void register_env_tools(capabilities::tool::ToolRegistry& registry);
