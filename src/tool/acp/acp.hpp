...
// ACP 协议核心
#include "tool/acp/core/types.hpp"
#include "tool/acp/core/content_block.hpp"
#include "tool/acp/core/message.hpp"

// ACP 编解码
#include "tool/acp/codec/serializer.hpp"
#include "tool/acp/codec/json_codec.hpp"

// ACP 流式处理
#include "tool/acp/stream/handler.hpp"
#include "tool/acp/stream/dispatcher.hpp"

// ACP 适配器
#include "tool/acp/adapter/tool_adapter.hpp"
